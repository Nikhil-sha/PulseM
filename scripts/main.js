document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadArtists() {
        ...
        artistList.innerHTML = artists.map(artist =>
            `<li class="p-2 bg-gray-100 rounded hover:bg-gray-200 cursor-pointer" data-artist="${artist}">
    ...
    function loadSongsByArtist(artist) {
        ...
        if (songs.length > 0) {
            ...
            songList.innerHTML = '<li>No songs available for this artist.</li>';
        }
    }
    ...
    function displaySongs() {
        songList.innerHTML = songs.map((song, index) =>
            `<li class="p-2 bg-gray-100 rounded hover:bg-gray-200 cursor-pointer" data-index="${index}">
